...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "letstalk.HelloRequest")
	proto.RegisterType((*HelloReply)(nil), "letstalk.HelloReply")
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := grpc.Invoke(ctx, "/letstalk.Greeter/SayHello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/letstalk.Greeter/SayHello",
	}
...
var fileDescriptor0 = []byte{
	...
	0x2e, 0x49, 0xcc, 0xc9, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x80, 0xf1, 0x95, 0x94,
	...
	0x02, 0x00, 0x00, 0xff, 0xff, 0x66, 0xe0, 0x87, 0xbd, 0xb5, 0x00, 0x00, 0x00,
}
