...
type LetstalkClient interface {
	...
	ServerComm(ctx context.Context, in *ServerCommArgs, opts ...grpc.CallOption) (*ServerCommReply, error)
}
...
func (c *letstalkClient) ServerComm(ctx context.Context, in *ServerCommArgs, opts ...grpc.CallOption) (*ServerCommReply, error) {
	out := new(ServerCommReply)
	err := grpc.Invoke(ctx, "/letstalk.Letstalk/ServerComm", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LetstalkServer interface {
	...
	ServerComm(context.Context, *ServerCommArgs) (*ServerCommReply, error)
}
...
func _Letstalk_ServerComm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ServerCommArgs)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LetstalkServer).ServerComm(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/letstalk.Letstalk/ServerComm",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LetstalkServer).ServerComm(ctx, req.(*ServerCommArgs))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Letstalk_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ServerComm",
			Handler:    _Letstalk_ServerComm_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
